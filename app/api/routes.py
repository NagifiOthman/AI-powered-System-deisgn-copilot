...
@router.post("/discovery-questions", response_model=DiscoveryQuestionsResponse)
async def discovery_questions(payload: CopilotRequest) -> DiscoveryQuestionsResponse:
    return await copilot_engine.generate_discovery_questions(payload)
